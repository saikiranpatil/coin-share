...
const GroupCard = ({ groupData }: { groupData: groupDataProps }) => {
    ...
    return (
        <Link href={"/group/" + groupData.id}>
            <Card className="flex flex-col text-center items-center justify-between space-y-0 gap-2 sm:gap-4 p-6 transition-all hover:shadow-md hover:border-primary/40 cursor-pointer">
